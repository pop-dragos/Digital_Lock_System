...
constant CNT_100HZ : integer :=2**20;  --2**20;                  -- divizor pentru rata de reimprospatare de ~100 Hz (cu un ceas de 100 MHz)
...
-- Selectia anodului activ
    An <= "11111111" when en = '0' else
          "11111110" when LedSel = "000" else
